...
import com.sc.dmh.beans.TabHsfSrtypeExample.Criteria;
...
public class SrtypeController {
	...
	@Autowired
	private HsfSrtypeServiceI hsfSrtypeService;
	
	

	public void setHsfSrtypeService(HsfSrtypeServiceI hsfShService) {
		this.hsfSrtypeService = hsfShService;
	}
...
//			public String fpAdd(TabHsfSrtype formSrtype, HttpServletRequest request,
...
//				if(userSession != null ){
//					//获取用户部门设置到车站id		
//					formSrtype.(userSession.getBumenId());
//					
//				}
//			
//				
...
//						
//						//添加粉票记录
//						int i = hsfShService.insertSelective(formSrtype);
//						
...
//				} 
						...
						@AuthPassport
						// 获取所有
						@RequestMapping("/getSrtypeAll")
						public String getShAll(HttpServletRequest request,
								HttpServletResponse resp) throws IOException {
							// @PathVariable
							// String
							// id(路径变量如@RequestMapping("/{id}/showUser"))
							...
							if(userSession == null ){
								...
								try {
									...
									TabHsfSrtypeExample example = new TabHsfSrtypeExample();
...
//									
									//查询当月当前车站售票记录
									List<TabHsfSrtype> rpfAll = hsfSrtypeService.selectByExample(example);
...
//						public String getSh(HttpServletRequest request,
//								HttpServletResponse resp) throws IOException {
//							// @PathVariable
//							// String
//							// id(路径变量如@RequestMapping("/{id}/showUser"))
