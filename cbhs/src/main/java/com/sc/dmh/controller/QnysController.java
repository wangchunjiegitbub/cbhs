...
public class QnysController {
	...
	public void setkemuService(KemuServiceI depService) {
		kemuService = depService;
	}
...
//									
									//查询当月当前车站售票记录
									List<TabKemu> rpfAll = kemuService.selectByExample(example);
