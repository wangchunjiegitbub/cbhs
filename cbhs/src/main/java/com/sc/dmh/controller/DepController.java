...
import com.sc.dmh.beans.TabDepartmentExample.Criteria;
...
public class DepController {
	...
	@Autowired
	private DepartmentServiceI depService;
	
	

	public void setTabDepartmentService(DepartmentServiceI viewCgService) {
		this.depService = viewCgService;
	}
...
//						
						...
						@AuthPassport
						// 获取所有
						@RequestMapping("/getDepAll")
						public String getKpylAll(HttpServletRequest request,
								HttpServletResponse resp) throws IOException {
							// @PathVariable
							// String
							// id(路径变量如@RequestMapping("/{id}/showUser"))
...
//							}
								...
								try {
									...
									TabDepartmentExample example = new TabDepartmentExample();
...
////									
									//查询当月当前车站售票记录
									List<TabDepartment> depAll = depService.selectByExample(example);
...
//									
									...
									// {"total":10 , "rows":[{},{}]}
									String json = "{\"total\":" + depAll.size() + " , \"rows\":"
											+ JSON.toJSONStringWithDateFormat(depAll, "yyyy-MM-dd") + "}";
						...
						@AuthPassport
						// 获取所有
						@RequestMapping("/getDepAllSelect")
						public String getDepAllSelect(HttpServletRequest request,
								HttpServletResponse resp) throws IOException {
							// @PathVariable
							// String
							// id(路径变量如@RequestMapping("/{id}/showUser"))
...
//									
									...
									// {"total":10 , "rows":[{},{}]}
									String json = JSON.toJSONStringWithDateFormat(depAll, "yyyy-MM-dd");
