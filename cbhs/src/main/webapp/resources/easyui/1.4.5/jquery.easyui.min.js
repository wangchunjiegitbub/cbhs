...
if(opts.modal){
_282.mask=$("<div class=\"window-mask\" style=\"display:none\"><iframe name='kill_activex3' frameborder='0' style='position: absolute; z-index: -1; width: 100%; height: 100%; top: 0;left:0;scrolling:no;'></iframe></div>").insertAfter(_282.window);
}
if(_282.shadow){
_282.shadow.remove();
}
if(opts.shadow){
_282.shadow=$("<div class=\"window-shadow\" style=\"display:none\"><iframe name='kill_activex2' frameborder='0' style='position: absolute; z-index: -1; width: 100%; height: 100%; top: 0;left:0;scrolling:no;'></iframe></div>").insertAfter(_282.window);
}
...
if(!_999.panel){
_999.panel=$("<div class=\"combo-panel\"><iframe name='kill_activex' frameborder='0' style='position: absolute; z-index: -1; width: 100%; height: 100%; top: 0;left:0;scrolling:no;'></iframe></div>").appendTo("body");
